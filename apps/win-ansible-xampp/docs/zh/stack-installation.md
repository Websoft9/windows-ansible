...
3. 若想用域名访问 XAMPP，请先到 **域名控制台** 完成一个域名解析
...
远程桌面登录到 Windows 服务器，查看 XAMPP 是否正常运行（图标为绿色），点击【Restart】按钮测试可用性。如果桌面右下角没有 XAMPP 图标，请重启服务器后再查看。

![](https://libs.websoft9.com/Websoft9/DocsPicture/zh/xampp/xampp-ui-websoft9.png)

## 登录数据库

XAMPP 预装包中内置 MySQL 及可视化数据库管理工具 `phpMyadmin` ，[马上登录](/zh/admin-mysql.md) 管理数据库

![9panel](https://libs.websoft9.com/Websoft9/DocsPicture/zh/9panel/9panel-mysql-websoft9.png)

## 安装网站

XAMPP 可以用来部署多个 PHP 网站，[马上开始吧](/zh/solution-deployment.md)
