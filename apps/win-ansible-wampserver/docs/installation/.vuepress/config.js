...
base: '/docs/wampserver/installation/',
...
locales: {
    '/': {
      ...
      description: 'You can get the Installation of opensource applications & CMS based on WampServer from this documentation powered by Websoft9.'
    },
    '/zh/': {
      lang: 'zh-CN',
      title: 'PHP 开源应用安装示例（集）',
      description: '本文档由Websoft9提供，汇总了数十个基于WampServer环境的主流开源PHP网站应用安装教程'
    }
},
